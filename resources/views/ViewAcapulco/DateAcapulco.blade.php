...
<div class="container">
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    <tr>@foreach ($query as $key => $value )
                        ...
                        <td>
                            <form action="{{route('DetalleAcapulco')}}" method="POST">
                                @method("PUT")
                                @csrf
        ...
        <form method="POST" action="{{ route('export')}}">
            @method('PUT')
            @csrf
            <input type="hidden" name="mivar" value="Select Select Folio,Codigo_SKU,Descripcion,Categoria,Tipo_Alimento,Animal,Marca,Peso,Precio_Venta,Cantidad,Subtotal,Descuento,Porcentaje,Total,Created_at from orders_acapulco;">
