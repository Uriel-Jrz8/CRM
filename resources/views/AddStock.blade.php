...
<div class="container">
  <div class=" shadow-lg p-4 mb-5 bg-white rounded">
    ...
    <form method="POST" action="{{route('UpdateStock')}}">
      ...
      @csrf
      <br>
      <H3 style="color: #DE2692">{{ __('Abastecer Sucursales') }} </H3>
      <div class="form-row">
        ...
        <div class="col-xs-8 col-sm-3"> <b><label style="color: #000" for="exampleInput1">Identificador Producto</label></b>
        ...
        <div class="col-xs-8 col-sm-3"> <b><label style="color: #000" for="exampleInput1">Cantidad de Productos</label></b>
    ...
    <form method="POST" action="{{route('UpdatePrecio')}}">
      @method('PUT')
      @csrf
      <br>
    ...
    <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data" class="was-validated">
      @method('PUT')
      @csrf
      <H3 class="" style="color: #DE2692;">{{ __('Importar Lista de Productos') }} </H3>
      <div class="form-row">
        <div class="col-xs-8 col-sm-3">
          <b><label class="" style="color: #000;" for="exampleInput1">Sucursal</label></b>
          <select name="sucursal" class="form-control1" style="color:#000;">
            <option>Selecciona Sucursal</option>
            <option>Almacen General</option>
            <option>En Linea</option>
            <option>Acapulco</option>
      ...
      <center><button class="btn btn-outline-pink"> Importar Archivo &nbsp <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-cloud-upload" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
