...
<div class="container">
    <div class=" shadow-lg p-4 mb-5 bg-white rounded">
        <div class="row justify-content-center center">
            ...
            </div><H1>{{ __('Bodega Merkado Croqueta') }} </H1>
        </div>
            ...
            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                ...
                <center><H1>{{ __('Nuevo Producto') }} </H1></center>
        ...
        <b><label class="text-info" for="exampleInput1">Identificador Pedido</label></b>
          <input type="text" class="form-control" name='id' autocomplete="off" placeholder="Número de Pedido" required onkeypress="return validaNumericos(event)">
        </div>
                     ...
                     <input type="text" class="form-control" name="precio" placeholder="Precio" required autocomplete ="off" onkeypress="return validaNumericos(event)"> </div>
                      ...
                      <div class="col-xs-8 col-sm-3"> <b><label style="color: #DE2692" for="exampleInput1">Identificador Producto</label></b>
                       ...
                       <input type="text" class="form-control" name="cantidad" placeholder="cantidad" autocomplete ="off" required onkeypress="return validaNumericos(event)"> </div>
                        ...
                        <div class="col-xs-8 col-sm-3"> <b><label style="color: #DE2692" for="exampleInput1">Sucursal</label></b> <select name="sucursal" class="form-control">
                            <option>En Linea</option>
                            <option>Acapulco</option>
                            <option>Ciudad de Mexico</option></select> </div>
                      </div>

                        <br><center><button class="btn btn-outline-pink" > Actualizar Producto <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
