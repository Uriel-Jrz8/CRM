...
<!-- <div class="container"> -->
    <!-- <div class="shadow-lg p-2 mb-5 bg-white rounded"> -->
        ...
        <div class="table-responsive">
            ...
            @method('PUT')
            @csrf
            <input type="hidden" name="mivar" value="select Id,Codigo_SKU,Descripcion,Categoria,Tipo_Alimento,Animal,Marca,Peso,Precio_Venta,Cantidad_Existente,Descuento,Porcentaje from stock_linea">
