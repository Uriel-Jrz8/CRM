...
<div class="container">
  <div class=" shadow-lg p-4 mb-5 bg-white rounded">
    ...
    <center>
      <h1 style="background-color:black; color:white;">Merkado Croqueta</h1>
    </center><br>
    @if (session('message'))
    ...
    <form method="POST" action="{{route('descuento')}}">
      ...
      <div class="form-row">
        ...
        <div class="col-xs-8 col-sm-3"> <b><label style="color: #000" for="exampleInput1">Sucursal</label></b> <select name="plataforma" class="form-control1">
