...
<div class="container">
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <form method="POST" action="{{ route('export')}}">
            @method('PUT')
            @csrf
            <input type="hidden" name="mivar" value="Select Folio,Codigo_SKU,Descripcion,Categoria,Tipo_Alimento,Animal,Marca,Peso,Precio_Venta,Cantidad,Subtotal,Descuento,Porcentaje,Total,Plataforma,Created_at from orders_linea;">
